    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <main className="relative z-10 px-4 sm:px-6 lg:px-8 pt-32 pb-20 flex flex-col items-center min-h-screen">
        ...
        <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-8 items-start justify-center">
          {/* Order Details - Left */}
          <div className="flex-1 w-full lg:max-w-2xl p-4 sm:p-6 lg:p-8 rounded-2xl bg-white/70 backdrop-blur-md shadow-2xl border-0 flex flex-col items-center">
          ...
          {/* Shipping Form - Right */}
          <div className="flex-1 w-full lg:max-w-xl p-4 sm:p-6 lg:p-8 rounded-2xl bg-white/70 backdrop-blur-md shadow-2xl border-0 flex flex-col items-center">
